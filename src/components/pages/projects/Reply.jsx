...
export default function Reply({ source, commentId, projectID }) {
  ...
  const [addComment, { data: commentresp, isLoading: commentLoading }] =
    useAddCommentMutation();
  const [addReply, { data: replyresp, isLoading: replyLoading }] =
    useAddReplyMutation();
                      ...
                      <>
                        <div className="flex items-center gap-2 p-2  w-full rounded-md ">
                          ...
                          <div className="gap-2 block">
                            ...
                            <span className="file-size">{files?.size} kb</span>
                          </div>
                        </div>
                      </>
                    )}
