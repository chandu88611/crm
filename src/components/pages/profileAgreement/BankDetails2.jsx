...
export default function BankDetails2({ handleActiveForm, profileDetails,notEdit,change }) {
  ...
  return
   ...
   if(response?.error?.data?.message){
    ...
    if (response?.data?.status) {
      if(response?.data?.message=="Update failed due to existing account number should not be the same as new account number"){
        Swal.fire({
          title: "Error",
    ...
    <div className="pulse">
      ...
      <form>
        <>
              ...
              <div>
                ...
                <div className="form-icon">
                  <input
                    ...
                    disabled={notEdit?notEdit:change}
          ...
          {(!notEdit)&&<div className="d-flex align-items-start gap-3 ">
