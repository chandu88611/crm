      ...
      reader.onload = () => {
        ...
        image.onload = () => {
          ...
          if (aspectRatio >= 2.2 && aspectRatio <= 4.5) {
            ...
            setProfileImgErr("Upload image of proper size ");
          }
        };
  ...
  const formSubmit = async (data, event) => {
    ...
    if (!companyNotExisted) {
      if (!file && !usePrevProof) {
        return setFileErr("GST/PAN proof is required");
      }
      if (
        !imgFile &&
        !profileDetails?.profile_info?.company_details?.tax_proof
      ) {
        return setProfileImgErr("Company logo is required");
      }
    }
    ...
    if (response?.data?.status) {
      ...
      Swal.fire({
        title: "Error",
        text: response?.error?.data?.errors?.logo_image
          ? response?.error?.data?.errors?.logo_image
                ...
                {image ? (
                  <div className="relative !h-fit">
                    <img
                      src={image}
                      alt="user-img"
                      className=" !align-middle  mr-2 !h-[65px] rounded border max-w-[147px] "
                    />
                    <span class="headline  ">
                      <i className="mdi mdi-arrow-left absolute left-0 -bottom-[2px] text-[11px] text-[#e74c3c] "></i>
                      <p>150 px</p>{" "}
                      <i className="mdi mdi-arrow-right absolute right-0 -bottom-[2px] text-[11px] text-[#e74c3c]"></i>
                    </span>
                  ...
                  <div className="px-4 flex items-center !align-middle !w-[200px] mr-2 h-[60px] rounded  ">
          ...
          <Form>
            <>
              <div className="row mt-2">
                ...
                <div className="col-xl-4 col-md-6">
                  ...
                  <input
                    ...
                    disabled={
                      notEdit ? notEdit : everything ? !everything : change
                    }
              ...
              {!adding && (
                <div className="form-check form-check-secondary my-3">
                  <input
                    ...
                    onChange={() => setCompanyNotExisted(!companyNotExisted)}
                  />
                  <span className="ml-2">
              ...
              <div className="d-flex align-items-start gap-3 -mt-2 ">
                ...
                <p>
                  {" "}
                  <b>Note:</b> Once you request an address update, we will send
                  a unique Postal OTP to your registered address. Only after
                  successful verification of your address will the withdrawal
                  feature be enabled.{" "}
                </p>
